...
#this script creates cdf files with a time variable. It it currently formatted to work for data beginning with the year 1985
...
#touch ${name}
cat ${name} | cdfmath "${fdate} time =" > timed/${name}
#echo $fdate
#echo $x
#echo $rdate
#rm ${name}
